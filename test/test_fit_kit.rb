...
class TestFitKit < Minitest::Test
  ...
  def test_series_of_heart_rate_values
    ...
    expected = [[1729101316, 95.4550408719346, "bpm"],
      [1729101707, 110.45524296675192, "bpm"],
      [1729102098, 125.65473145780051, "bpm"],
      [1729102489, 113.9079283887468, "bpm"],
      [1729102880, 118.0460358056266, "bpm"],
      [1729103271, 128.98209718670077, "bpm"],
      [1729103662, 126.08951406649616, "bpm"],
      [1729104053, 123.47314578005115, "bpm"],
      [1729104444, 134.49872122762147, "bpm"],
      [1729104835, 139.71355498721226, "bpm"],
      [1729105226, 118.33333333333333, "bpm"]]
  ...
  def test_series_of_cadence_values
    ...
    expected = [[1729101316, 60.2425068119891, "rpm"],
      [1729101707, 67.07142857142857, "rpm"],
      [1729102098, 87.18414322250639, "rpm"],
      [1729102489, 62.43734015345269, "rpm"],
      [1729102880, 52.089514066496164, "rpm"],
      [1729103271, 63.667519181585675, "rpm"],
      [1729103662, 63.43478260869565, "rpm"],
      [1729104053, 71.13351498637603, "rpm"],
      [1729104444, 82.51968503937007, "rpm"],
